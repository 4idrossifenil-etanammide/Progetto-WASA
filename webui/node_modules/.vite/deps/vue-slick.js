...
var require_slick = __commonJS({
  "node_modules/slick-carousel/slick/slick.js"(exports, module) {
    (function(factory) {
      ...
      "use strict";
      var Slick2 = window.Slick || {};
      Slick2 = function() {
        var instanceUid = 0;
        function Slick3(element, settings) {
      ...
      Slick2.prototype.activateADA = function() {
        var _ = this;
      ...
      Slick2.prototype.addSlide = Slick2.prototype.slickAdd = function(markup, index, addBefore) {
        var _ = this;
      ...
      Slick2.prototype.animateHeight = function() {
        var _ = this;
      ...
      Slick2.prototype.animateSlide = function(targetLeft, callback) {
      ...
      Slick2.prototype.getNavTarget = function() {
      ...
      Slick2.prototype.asNavFor = function(index) {
      ...
      Slick2.prototype.buildRows = function() {
      ...
      Slick2.prototype.checkResponsive = function(initial, forceUpdate) {
      ...
      Slick2.prototype.changeSlide = function(event, dontAnimate) {
      ...
      Slick2.prototype.checkNavigable = function(index) {
      ...
      Slick2.prototype.cleanUpEvents = function() {
        var _ = this;
      ...
      Slick2.prototype.clickHandler = function(event) {
        var _ = this;
      ...
      Slick2.prototype.destroy = function(refresh) {
        var _ = this;
        _.autoPlayClear();
        _.touchObject = {};
        _.cleanUpEvents();
      ...
      Slick2.prototype.fadeSlideOut = function(slideIndex) {
        var _ = this;
        if (_.cssTransitions === false) {
          _.$slides.eq(slideIndex).animate({
            opacity: 0,
      ...
      Slick2.prototype.filterSlides = Slick2.prototype.slickFilter = function(filter) {
        var _ = this;
        if (filter !== null) {
          _.$slidesCache = _.$slides;
          _.unload();
      ...
      Slick2.prototype.focusHandler = function() {
        var _ = this;
      ...
      Slick2.prototype.getCurrent = Slick2.prototype.slickCurrentSlide = function() {
        var _ = this;
      ...
      Slick2.prototype.getOption = Slick2.prototype.slickGetOption = function(option) {
        var _ = this;
        return _.options[option];
      };
      Slick2.prototype.getNavigableIndexes = function() {
      ...
      Slick2.prototype.getSlick = function() {
        return this;
      };
      Slick2.prototype.getSlideCount = function() {
      ...
      Slick2.prototype.goTo = Slick2.prototype.slickGoTo = function(slide, dontAnimate) {
        var _ = this;
        _.changeSlide({
          data: {
            message: "index",
      ...
      Slick2.prototype.init = function(creation) {
        var _ = this;
      ...
      Slick2.prototype.initADA = function() {
      ...
      Slick2.prototype.initSlideEvents = function() {
        var _ = this;
      ...
      Slick2.prototype.next = Slick2.prototype.slickNext = function() {
        var _ = this;
        _.changeSlide({
          data: {
            message: "next"
      ...
      Slick2.prototype.orientationChange = function() {
        var _ = this;
        _.checkResponsive();
        _.setPosition();
      };
      Slick2.prototype.pause = Slick2.prototype.slickPause = function() {
        var _ = this;
        _.autoPlayClear();
        _.paused = true;
      };
      Slick2.prototype.play = Slick2.prototype.slickPlay = function() {
        var _ = this;
        _.autoPlay();
      ...
      Slick2.prototype.prev = Slick2.prototype.slickPrev = function() {
        var _ = this;
        _.changeSlide({
          data: {
            message: "previous"
      ...
      Slick2.prototype.preventDefault = function(event) {
        event.preventDefault();
      };
      Slick2.prototype.progressiveLazyLoad = function(tryCount) {
        tryCount = tryCount || 1;
      ...
      Slick2.prototype.refresh = function(initializing) {
      ...
      Slick2.prototype.registerBreakpoints = function() {
      ...
      Slick2.prototype.resize = function() {
        var _ = this;
      ...
      Slick2.prototype.removeSlide = Slick2.prototype.slickRemove = function(index, removeBefore, removeAll) {
        var _ = this;
        if (typeof index === "boolean") {
          removeBefore = index;
      ...
      Slick2.prototype.setHeight = function() {
        var _ = this;
        if (_.options.slidesToShow === 1 && _.options.adaptiveHeight === true && _.options.vertical === false) {
          var targetHeight = _.$slides.eq(_.currentSlide).outerHeight(true);
      ...
      Slick2.prototype.setOption = Slick2.prototype.slickSetOption = function() {
      ...
      Slick2.prototype.interrupt = function(toggle) {
        var _ = this;
        if (!toggle) {
          _.autoPlay();
        }
      ...
      Slick2.prototype.slideHandler = function(index, sync, dontAnimate) {
      ...
      Slick2.prototype.unfilterSlides = Slick2.prototype.slickUnfilter = function() {
        var _ = this;
      ...
      Slick2.prototype.unslick = function(fromBreakpoint) {
        var _ = this;
      ...
      Slick2.prototype.visibility = function() {
        var _ = this;
        if (_.options.autoplay) {
...
var script = {
  ...
  destroyed: function() {
    (0, import_jquery.default)(this.$el).slick("unslick");
  },
  methods: {
    create: function() {
      var $slick = (0, import_jquery.default)(this.$el);
    ...
    next: function() {
      (0, import_jquery.default)(this.$el).slick("slickNext");
    },
    prev: function() {
      (0, import_jquery.default)(this.$el).slick("slickPrev");
    },
    pause: function() {
      (0, import_jquery.default)(this.$el).slick("slickPause");
    },
    play: function() {
      (0, import_jquery.default)(this.$el).slick("slickPlay");
    },
    goTo: function(index, dontAnimate) {
      (0, import_jquery.default)(this.$el).slick("slickGoTo", index, dontAnimate);
    },
    currentSlide: function() {
      return (0, import_jquery.default)(this.$el).slick("slickCurrentSlide");
    },
    add: function(element, index, addBefore) {
      (0, import_jquery.default)(this.$el).slick("slickAdd", element, index, addBefore);
    },
    remove: function(index, removeBefore) {
      (0, import_jquery.default)(this.$el).slick("slickRemove", index, removeBefore);
    },
    filter: function(filterData) {
      (0, import_jquery.default)(this.$el).slick("slickFilter", filterData);
    },
    unfilter: function() {
      (0, import_jquery.default)(this.$el).slick("slickUnfilter");
    },
    getOption: function(option) {
      (0, import_jquery.default)(this.$el).slick("slickGetOption", option);
    },
    setOption: function(option, value, refresh) {
      (0, import_jquery.default)(this.$el).slick("slickSetOption", option, value, refresh);
    },
    setPosition: function() {
      (0, import_jquery.default)(this.$el).slick("setPosition");
    },
...
var install = function installMyComponent(Vue, opt) {
  if (install.installed || Vue.prototype.$isServer) {
    return;
  }
...
var slickCarousel_esm_default = Slick;

// dep:vue-slick
var vue_slick_default = slickCarousel_esm_default;
export {
  vue_slick_default as default
};
/*!
 ...
 */
//# sourceMappingURL=vue-slick.js.map
